SUBROUTINE np_ccd_t2_disconnected(N,f1,i0,i1,nocc,t2,v2)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p3
...
DO h1=1,nocc
DO h2=1,nocc
i1(((((h5-1)*N+h6-1)*N+h1-1)*N+h2))=0.0d0
END DO
END DO
END DO
END DO
...
DO h2=1,nocc
TMP=0.0d0
TMP=TMP+v2(((((h5-1)*N+h6-1)*N+h1-1)*N+h2))
i1(((((h5-1)*N+h6-1)*N+h1-1)*N+h2))=i1(((((h5-1)*N+h6-1)*N+h1-1)*N+h2))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO p7=nocc+1,N
DO p8=nocc+1,N
TMP=TMP+t2(((((p7-1)*N+p8-1)*N+h1-1)*N+h2))*v2(((((h5-1)*N+h6-1)*N+p7-1)*N+p8))
END DO
END DO
i1(((((h5-1)*N+h6-1)*N+h1-1)*N+h2))=i1(((((h5-1)*N+h6-1)*N+h1-1)*N+h2))+(0.5d0)*TMP
END DO
END DO
END DO
END DO
...
DO h5=1,nocc
DO h6=1,nocc
TMP=TMP+t2(((((p3-1)*N+p4-1)*N+h5-1)*N+h6))*i1(((((h5-1)*N+h6-1)*N+h1-1)*N+h2))
END DO
END DO
...
i0(((((p3-1)*N+p4-1)*N+h1-1)*N+h2))=i0(((((p3-1)*N+p4-1)*N+h1-1)*N+h2))+(0.25d0)*TMP
END DO
END DO
END DO
END DO
