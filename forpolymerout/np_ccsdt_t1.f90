SUBROUTINE np_ccsdt_t1(N,f1,i0,i1,i2,nocc,t1,t2,t3,v2)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p2
...
DO p3=nocc+1,N
TMP=0.0d0
TMP=TMP+f1(((h7-1)*N+p3))
i2(((h7-1)*N+p3))=i2(((h7-1)*N+p3))+(1.0d0)*TMP
END DO
END DO
DO h7=1,nocc
DO p3=nocc+1,N
...
DO h6=1,nocc
DO p5=nocc+1,N
TMP=TMP+t1(((p5-1)*N+h6))*v2(((((h6-1)*N+h7-1)*N+p3-1)*N+p5))
END DO
END DO
i2(((h7-1)*N+p3))=i2(((h7-1)*N+p3))+(-1.0d0)*TMP
END DO
...
TMP=0.0d0
DO p3=nocc+1,N
TMP=TMP+t1(((p3-1)*N+h1))*i2(((h7-1)*N+p3))
END DO
i1(((h7-1)*N+h1))=i1(((h7-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
...
DO p3=nocc+1,N
DO p4=nocc+1,N
TMP=TMP+t3(((((((p2-1)*N+p3-1)*N+p4-1)*N+h1-1)*N+h5-1)*N+h6))*v2(((((h5-1)*N+h6-1)*N+p3-1)*N+p4))
END DO
END DO
END DO
END DO
i0(((p2-1)*N+h1))=i0(((p2-1)*N+h1))+(0.25d0)*TMP
END DO
END DO
DO p2=nocc+1,N
DO h1=1,nocc
