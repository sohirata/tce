SUBROUTINE np_m_ccd_t2(N,f1,i0,i1,m,nocc,t2,v2)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p3
...
DO h1=1,nocc
DO h2=1,nocc
i1(((((m(h7)-1)*N+m(h9)-1)*N+m(h1)-1)*N+m(h2)))=0.0d0
END DO
END DO
END DO
END DO
...
DO h2=1,nocc
TMP=0.0d0
TMP=TMP+v2(((((m(h7)-1)*N+m(h9)-1)*N+m(h1)-1)*N+m(h2)))
i1(((((m(h7)-1)*N+m(h9)-1)*N+m(h1)-1)*N+m(h2)))=i1(((((m(h7)-1)*N+m(h9)-1)*N+m(h1)-1)*N+m(h2)))+(-1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO p5=nocc+1,N
DO p6=nocc+1,N
TMP=TMP+t2(((((m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(h2)))*v2(((((m(h7)-1)*N+m(h9)-1)*N+m(p5)-1)*N+m(p6)))
END DO
END DO
i1(((((m(h7)-1)*N+m(h9)-1)*N+m(h1)-1)*N+m(h2)))=i1(((((m(h7)-1)*N+m(h9)-1)*N+m(h1)-1)*N+m(h2)))+(-0.5d0)*TMP
END DO
END DO
END DO
END DO
...
DO h9=1,nocc
DO h7=1,nocc
TMP=TMP+t2(((((m(p3)-1)*N+m(p4)-1)*N+m(h7)-1)*N+m(h9)))*i1(((((m(h7)-1)*N+m(h9)-1)*N+m(h1)-1)*N+m(h2)))
END DO
END DO
