SUBROUTINE np_m_ccsdt_t2_disconnected(N,f1,i0,i1,i2,i3,m,nocc,t1,t2,t3,v2)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p3
...
DO p5=nocc+1,N
DO p6=nocc+1,N
TMP=TMP+t3(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(h7)-1)*N+m(h8)))*v2(((((m(h7)-1)*N+m(h8)-1)*N+m(p5)-1)*N+m(p6)))
END DO
END DO
END DO
END DO
i1(((m(p3)-1)*N+m(h1)))=i1(((m(p3)-1)*N+m(h1)))+(0.25d0)*TMP
END DO
END DO
DO h6=1,nocc
DO p5=nocc+1,N
...
DO p5=nocc+1,N
DO p6=nocc+1,N
TMP=TMP+t3(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(h2)-1)*N+m(h7)))*v2(((((m(h7)-1)*N+m(h9)-1)*N+m(p5)-1)*N+m(p6)))
END DO
END DO
END DO
i1(((((m(h9)-1)*N+m(p3)-1)*N+m(h1)-1)*N+m(h2)))=i1(((((m(h9)-1)*N+m(p3)-1)*N+m(h1)-1)*N+m(h2)))+(0.5d0)*TMP
