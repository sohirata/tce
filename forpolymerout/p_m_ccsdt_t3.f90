SUBROUTINE p_m_ccsdt_t3(N,f1,f1e,i0,i0e,i1,i1e,i2,i2e,i3,i3e,m,nocc,t1,t1e,t2,t2e,t3,t3e,v2,v2e)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p4
...
DO h1=1,nocc
DO p7=nocc+1,N
v2e(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7)))= + v2(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7)))
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p7=nocc+1,N
i3(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7)))=(1.0d0)*v2e(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7)))
END DO
END DO
END DO
END DO
...
DO p8=nocc+1,N
IF (p7>p8) CYCLE
v2e(((((m(h10)-1)*N+m(h11)-1)*N+m(p8)-1)*N+m(p7)))= - v2(((((m(h10)-1)*N+m(h11)-1)*N+m(p7)-1)*N+m(p8)))
v2e(((((m(h10)-1)*N+m(h11)-1)*N+m(p7)-1)*N+m(p8)))= + v2(((((m(h10)-1)*N+m(h11)-1)*N+m(p7)-1)*N+m(p8)))
END DO
END DO
END DO
END DO
...
DO p7=nocc+1,N
DO p8=nocc+1,N
i3(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7)))=i3(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7)))+(-0.5d0)*t1(((m(p8)-1)*N+m(h1))&
&)*v2e(((((m(h10)-1)*N+m(h11)-1)*N+m(p7)-1)*N+m(p8)))
END DO
END DO
END DO
END DO
...
IF (h1>h2) CYCLE
DO p7=nocc+1,N
i2(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(h2)))=i2(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(h2)))+(-1.0d0)*t1(((m(p7)-1)*N+m(h1))&
&)*i3(((((m(h10)-1)*N+m(h11)-1)*N+m(h2)-1)*N+m(p7)))+(1.0d0)*t1(((m(p7)-1)*N+m(h2)))*i3(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7&
&)))
END DO
END DO
END DO
...
DO p9=nocc+1,N
IF (p8>p9) CYCLE
i2(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(h2)))=i2(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(h2)))+(1.0d0)*t2(((((m(p8)-1)*N+m(p9)&
&-1)*N+m(h1)-1)*N+m(h2)))*v2(((((m(h10)-1)*N+m(h11)-1)*N+m(p8)-1)*N+m(p9)))
END DO
END DO
END DO
END DO
...
IF (h1>h2) CYCLE
DO h10=1,nocc
i1(((((m(h11)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))=i1(((((m(h11)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))+(1.0d0)*t1(((m(p4)-1)*N+m(h10)))*&
...
DO h11=1,nocc
DO p7=nocc+1,N
i2(((m(h11)-1)*N+m(p7)))=(1.0d0)*f1(((m(h11)-1)*N+m(p7)))
END DO
END DO
DO h11=1,nocc
DO h10=1,nocc
...
DO p9=nocc+1,N
IF (p7>p9) CYCLE
v2e(((((m(h11)-1)*N+m(h10)-1)*N+m(p9)-1)*N+m(p7)))= + v2(((((m(h10)-1)*N+m(h11)-1)*N+m(p7)-1)*N+m(p9)))
v2e(((((m(h11)-1)*N+m(h10)-1)*N+m(p7)-1)*N+m(p9)))= - v2(((((m(h10)-1)*N+m(h11)-1)*N+m(p7)-1)*N+m(p9)))
v2e(((((m(h10)-1)*N+m(h11)-1)*N+m(p9)-1)*N+m(p7)))= - v2(((((m(h10)-1)*N+m(h11)-1)*N+m(p7)-1)*N+m(p9)))
v2e(((((m(h10)-1)*N+m(h11)-1)*N+m(p7)-1)*N+m(p9)))= + v2(((((m(h10)-1)*N+m(h11)-1)*N+m(p7)-1)*N+m(p9)))
END DO
END DO
END DO
END DO
...
DO p9=nocc+1,N
DO h10=1,nocc
i2(((m(h11)-1)*N+m(p7)))=i2(((m(h11)-1)*N+m(p7)))+(-1.0d0)*t1(((m(p9)-1)*N+m(h10)))*v2e(((((m(h10)-1)*N+m(h11)-1)*N+m(p7)-1)*N+m(p9&
&)))
END DO
END DO
END DO
...
DO h2=1,nocc
IF (h1>h2) CYCLE
t2e(((((m(p7)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))= - t2(((((m(p4)-1)*N+m(p7)-1)*N+m(h1)-1)*N+m(h2)))
t2e(((((m(p4)-1)*N+m(p7)-1)*N+m(h1)-1)*N+m(h2)))= + t2(((((m(p4)-1)*N+m(p7)-1)*N+m(h1)-1)*N+m(h2)))
END DO
END DO
END DO
END DO
...
IF (h1>h2) CYCLE
DO p7=nocc+1,N
i1(((((m(h11)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))=i1(((((m(h11)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))+(-1.0d0)*t2e(((((m(p4)-1)*N+m(p7)&
&-1)*N+m(h1)-1)*N+m(h2)))*i2(((m(h11)-1)*N+m(p7)))
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p10=nocc+1,N
v2e(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))= + v2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p10=nocc+1,N
i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))=(1.0d0)*v2e(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p10=nocc+1,N
i3(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))=(1.0d0)*v2e(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))
END DO
END DO
END DO
END DO
...
DO p7=nocc+1,N
IF (p7>p10) CYCLE
v2e(((((m(h11)-1)*N+m(h12)-1)*N+m(p10)-1)*N+m(p7)))= - v2(((((m(h11)-1)*N+m(h12)-1)*N+m(p7)-1)*N+m(p10)))
v2e(((((m(h11)-1)*N+m(h12)-1)*N+m(p7)-1)*N+m(p10)))= + v2(((((m(h11)-1)*N+m(h12)-1)*N+m(p7)-1)*N+m(p10)))
END DO
END DO
END DO
END DO
...
DO p10=nocc+1,N
DO p7=nocc+1,N
i3(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))=i3(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))+(1.0d0)*t1(((m(p7)-1)*N+m(h1)&
&))*v2e(((((m(h11)-1)*N+m(h12)-1)*N+m(p7)-1)*N+m(p10)))
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p10=nocc+1,N
i3e(((((m(h12)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p10)))= - i3(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))
i3e(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))= + i3(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))
END DO
END DO
END DO
END DO
...
DO p10=nocc+1,N
DO h11=1,nocc
i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))=i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))+(0.5d0)*t1(((m(p4)-1)*N+m(h11))&
&)*i3e(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))
END DO
END DO
END DO
END DO
...
DO p7=nocc+1,N
IF (p7>p10) CYCLE
v2e(((((m(h12)-1)*N+m(p4)-1)*N+m(p10)-1)*N+m(p7)))= - v2(((((m(h12)-1)*N+m(p4)-1)*N+m(p7)-1)*N+m(p10)))
v2e(((((m(h12)-1)*N+m(p4)-1)*N+m(p7)-1)*N+m(p10)))= + v2(((((m(h12)-1)*N+m(p4)-1)*N+m(p7)-1)*N+m(p10)))
END DO
END DO
END DO
END DO
...
DO p10=nocc+1,N
DO p7=nocc+1,N
i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))=i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))+(1.0d0)*t1(((m(p7)-1)*N+m(h1)))&
&*v2e(((((m(h12)-1)*N+m(p4)-1)*N+m(p7)-1)*N+m(p10)))
END DO
END DO
END DO
END DO
...
DO p8=nocc+1,N
IF (p8>p10) CYCLE
v2e(((((m(h12)-1)*N+m(h9)-1)*N+m(p10)-1)*N+m(p8)))= + v2(((((m(h9)-1)*N+m(h12)-1)*N+m(p8)-1)*N+m(p10)))
v2e(((((m(h12)-1)*N+m(h9)-1)*N+m(p8)-1)*N+m(p10)))= - v2(((((m(h9)-1)*N+m(h12)-1)*N+m(p8)-1)*N+m(p10)))
v2e(((((m(h9)-1)*N+m(h12)-1)*N+m(p10)-1)*N+m(p8)))= - v2(((((m(h9)-1)*N+m(h12)-1)*N+m(p8)-1)*N+m(p10)))
v2e(((((m(h9)-1)*N+m(h12)-1)*N+m(p8)-1)*N+m(p10)))= + v2(((((m(h9)-1)*N+m(h12)-1)*N+m(p8)-1)*N+m(p10)))
END DO
END DO
END DO
END DO
...
DO p8=nocc+1,N
DO h9=1,nocc
i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))=i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))+(-1.0d0)*t2e(((((m(p4)-1)*N+m(p&
&8)-1)*N+m(h1)-1)*N+m(h9)))*v2e(((((m(h9)-1)*N+m(h12)-1)*N+m(p8)-1)*N+m(p10)))
END DO
END DO
END DO
END DO
...
DO h2=1,nocc
IF (h1>h2) CYCLE
t2e(((((m(p10)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))= - t2(((((m(p4)-1)*N+m(p10)-1)*N+m(h1)-1)*N+m(h2)))
t2e(((((m(p4)-1)*N+m(p10)-1)*N+m(h1)-1)*N+m(h2)))= + t2(((((m(p4)-1)*N+m(p10)-1)*N+m(h1)-1)*N+m(h2)))
END DO
END DO
END DO
END DO
...
&)-1)*N+m(h3)))+(-0.16666666666666666d0)*t2e(((((m(p4)-1)*N+m(p10)-1)*N+m(h1)-1)*N+m(h2)))*i2(((((m(h12)-1)*N+m(p5)-1)*N+m(h3)-1)*N&
&+m(p10)))+(-0.16666666666666666d0)*t2e(((((m(p4)-1)*N+m(p10)-1)*N+m(h2)-1)*N+m(h3)))*i2(((((m(h12)-1)*N+m(p5)-1)*N+m(h1)-1)*N+m(p1&
&0)))+(0.16666666666666666d0)*t2e(((((m(p4)-1)*N+m(p10)-1)*N+m(h1)-1)*N+m(h3)))*i2(((((m(h12)-1)*N+m(p5)-1)*N+m(h2)-1)*N+m(p10)))+(&
&0.16666666666666666d0)*t2e(((((m(p5)-1)*N+m(p10)-1)*N+m(h1)-1)*N+m(h2)))*i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h3)-1)*N+m(p10)))+(0.1666&
&6666666666666d0)*t2e(((((m(p5)-1)*N+m(p10)-1)*N+m(h2)-1)*N+m(h3)))*i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))+(-0.166666666&
&66666666d0)*t2e(((((m(p5)-1)*N+m(p10)-1)*N+m(h1)-1)*N+m(h3)))*i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h2)-1)*N+m(p10)))
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p11=nocc+1,N
v2e(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))= + v2(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p11=nocc+1,N
i2(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))=(1.0d0)*v2e(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))
END DO
END DO
END DO
END DO
...
DO p7=nocc+1,N
IF (p7>p11) CYCLE
v2e(((((m(h9)-1)*N+m(h12)-1)*N+m(p11)-1)*N+m(p7)))= - v2(((((m(h9)-1)*N+m(h12)-1)*N+m(p7)-1)*N+m(p11)))
v2e(((((m(h9)-1)*N+m(h12)-1)*N+m(p7)-1)*N+m(p11)))= + v2(((((m(h9)-1)*N+m(h12)-1)*N+m(p7)-1)*N+m(p11)))
END DO
END DO
END DO
END DO
...
DO p11=nocc+1,N
DO p7=nocc+1,N
i2(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))=i2(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))+(1.0d0)*t1(((m(p7)-1)*N+m(h1)))&
&*v2e(((((m(h9)-1)*N+m(h12)-1)*N+m(p7)-1)*N+m(p11)))
END DO
END DO
END DO
END DO
...
DO h3=1,nocc
DO p11=nocc+1,N
i2e(((((m(h12)-1)*N+m(h9)-1)*N+m(h3)-1)*N+m(p11)))= - i2(((((m(h9)-1)*N+m(h12)-1)*N+m(h3)-1)*N+m(p11)))
i2e(((((m(h9)-1)*N+m(h12)-1)*N+m(h3)-1)*N+m(p11)))= + i2(((((m(h9)-1)*N+m(h12)-1)*N+m(h3)-1)*N+m(p11)))
END DO
END DO
END DO
END DO
...
DO h9=1,nocc
i1(((((((m(h12)-1)*N+m(p4)-1)*N+m(p5)-1)*N+m(h1)-1)*N+m(h2)-1)*N+m(h3)))=i1(((((((m(h12)-1)*N+m(p4)-1)*N+m(p5)-1)*N+m(h1)-1)*N+m(h2&
&)-1)*N+m(h3)))+(0.16666666666666666d0)*t3e(((((((m(p4)-1)*N+m(p5)-1)*N+m(p11)-1)*N+m(h1)-1)*N+m(h2)-1)*N+m(h9)))*i2e(((((m(h9)-1)*&
&N+m(h12)-1)*N+m(h3)-1)*N+m(p11)))+(0.16666666666666666d0)*t3e(((((((m(p4)-1)*N+m(p5)-1)*N+m(p11)-1)*N+m(h2)-1)*N+m(h3)-1)*N+m(h9))&
&)*i2e(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))+(-0.16666666666666666d0)*t3e(((((((m(p4)-1)*N+m(p5)-1)*N+m(p11)-1)*N+m(h1)-1)&
&*N+m(h3)-1)*N+m(h9)))*i2e(((((m(h9)-1)*N+m(h12)-1)*N+m(h2)-1)*N+m(p11)))
END DO
END DO
END DO
END DO
...
&)-1)*N+m(h3)))+(-2.0d0)*t3e(((((((m(p4)-1)*N+m(p9)-1)*N+m(p10)-1)*N+m(h1)-1)*N+m(h2)-1)*N+m(h3)))*v2(((((m(h8)-1)*N+m(h12)-1)*N+m(&
&p9)-1)*N+m(p10)))
END DO
END DO
END DO
