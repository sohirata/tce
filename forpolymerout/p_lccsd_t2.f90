SUBROUTINE p_lccsd_t2(N,f1,f1e,i0,i0e,nocc,t1,t1e,t2,t2e,v2,v2e)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p3
...
DO h2=1,nocc
IF (h1>h2) CYCLE
v2e(((((h5-1)*N+p4-1)*N+h1-1)*N+h2))= + v2(((((h5-1)*N+p4-1)*N+h1-1)*N+h2))
END DO
END DO
END DO
END DO
...
IF (h1>h2) CYCLE
DO h5=1,nocc
i0(((((p3-1)*N+p4-1)*N+h1-1)*N+h2))=i0(((((p3-1)*N+p4-1)*N+h1-1)*N+h2))+(-1.0d0)*t1(((p3-1)*N+h5))*v2e(((((h5-1)*N+p4-1)*N+h1-1)*N+&
&h2))+(1.0d0)*t1(((p4-1)*N+h5))*v2e(((((h5-1)*N+p3-1)*N+h1-1)*N+h2))
END DO
END DO
END DO
END DO
...
DO h2=1,nocc
DO p5=nocc+1,N
v2e(((((p3-1)*N+p4-1)*N+h2-1)*N+p5))= + v2(((((p3-1)*N+p4-1)*N+h2-1)*N+p5))
END DO
END DO
END DO
END DO
...
IF (h1>h2) CYCLE
DO p5=nocc+1,N
i0(((((p3-1)*N+p4-1)*N+h1-1)*N+h2))=i0(((((p3-1)*N+p4-1)*N+h1-1)*N+h2))+(-1.0d0)*t1(((p5-1)*N+h1))*v2e(((((p3-1)*N+p4-1)*N+h2-1)*N+&
&p5))+(1.0d0)*t1(((p5-1)*N+h2))*v2e(((((p3-1)*N+p4-1)*N+h1-1)*N+p5))
END DO
END DO
END DO
END DO
