SUBROUTINE p_ccd_t2(N,f1,f1e,i0,i0e,i1,i1e,nocc,t2,t2e,v2,v2e)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p3
...
DO h2=1,nocc
IF (h1>h2) CYCLE
i1(((((h7-1)*N+h9-1)*N+h1-1)*N+h2))=(-1.0d0)*v2(((((h7-1)*N+h9-1)*N+h1-1)*N+h2))
END DO
END DO
END DO
END DO
...
DO p6=nocc+1,N
IF (p5>p6) CYCLE
i1(((((h7-1)*N+h9-1)*N+h1-1)*N+h2))=i1(((((h7-1)*N+h9-1)*N+h1-1)*N+h2))+(-1.0d0)*t2(((((p5-1)*N+p6-1)*N+h1-1)*N+h2))*v2(((((h7-1)*N&
&+h9-1)*N+p5-1)*N+p6))
END DO
END DO
END DO
...
DO h9=1,nocc
IF (h7>h9) CYCLE
i0(((((p3-1)*N+p4-1)*N+h1-1)*N+h2))=i0(((((p3-1)*N+p4-1)*N+h1-1)*N+h2))+(-1.0d0)*t2(((((p3-1)*N+p4-1)*N+h7-1)*N+h9))*i1(((((h7-1)*N&
&+h9-1)*N+h1-1)*N+h2))
END DO
END DO
END DO
