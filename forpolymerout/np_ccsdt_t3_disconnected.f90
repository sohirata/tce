SUBROUTINE np_ccsdt_t3_disconnected(N,f1,i0,i1,i2,i3,nocc,t1,t2,t3,v2)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p4
...
DO h2=1,nocc
TMP=0.0d0
TMP=TMP+v2(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))
i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))=i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
TMP=0.0d0
TMP=TMP+f1(((p4-1)*N+h1))
i2(((p4-1)*N+h1))=i2(((p4-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
DO h11=1,nocc
DO h1=1,nocc
...
i3(((h11-1)*N+h1))=i3(((h11-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
DO h11=1,nocc
DO h1=1,nocc
TMP=0.0d0
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h1))*f1(((h11-1)*N+p7))
END DO
i3(((h11-1)*N+h1))=i3(((h11-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
...
END DO
END DO
i3(((h11-1)*N+h1))=i3(((h11-1)*N+h1))+(-0.5d0)*TMP
END DO
END DO
DO p4=nocc+1,N
DO h1=1,nocc
TMP=0.0d0
DO h11=1,nocc
TMP=TMP+t1(((p4-1)*N+h11))*i3(((h11-1)*N+h1))
END DO
i2(((p4-1)*N+h1))=i2(((p4-1)*N+h1))+(-1.0d0)*TMP
END DO
END DO
...
i3(((p4-1)*N+p7))=i3(((p4-1)*N+p7))+(1.0d0)*TMP
END DO
END DO
DO p4=nocc+1,N
DO p7=nocc+1,N
...
END DO
END DO
i3(((p4-1)*N+p7))=i3(((p4-1)*N+p7))+(-0.5d0)*TMP
END DO
END DO
DO p4=nocc+1,N
DO h1=1,nocc
TMP=0.0d0
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h1))*i3(((p4-1)*N+p7))
END DO
i2(((p4-1)*N+h1))=i2(((p4-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
...
DO h8=1,nocc
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h8))*v2(((((h8-1)*N+p4-1)*N+h1-1)*N+p7))
END DO
END DO
i2(((p4-1)*N+h1))=i2(((p4-1)*N+h1))+(-1.0d0)*TMP
END DO
...
DO p11=nocc+1,N
TMP=0.0d0
TMP=TMP+f1(((h9-1)*N+p11))
i3(((h9-1)*N+p11))=i3(((h9-1)*N+p11))+(1.0d0)*TMP
END DO
END DO
DO h9=1,nocc
DO p11=nocc+1,N
...
DO h8=1,nocc
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h8))*v2(((((h8-1)*N+h9-1)*N+p7-1)*N+p11))
END DO
END DO
i3(((h9-1)*N+p11))=i3(((h9-1)*N+p11))+(1.0d0)*TMP
END DO
...
DO h9=1,nocc
DO p11=nocc+1,N
TMP=TMP+t2(((((p4-1)*N+p11-1)*N+h1-1)*N+h9))*i3(((h9-1)*N+p11))
END DO
END DO
i2(((p4-1)*N+h1))=i2(((p4-1)*N+h1))+(1.0d0)*TMP
END DO
...
DO h9=1,nocc
DO p7=nocc+1,N
TMP=TMP+t2(((((p4-1)*N+p7-1)*N+h8-1)*N+h9))*v2(((((h8-1)*N+h9-1)*N+h1-1)*N+p7))
END DO
END DO
END DO
i2(((p4-1)*N+h1))=i2(((p4-1)*N+h1))+(-0.5d0)*TMP
END DO
END DO
DO p4=nocc+1,N
DO h1=1,nocc
...
DO p7=nocc+1,N
DO p8=nocc+1,N
TMP=TMP+t2(((((p7-1)*N+p8-1)*N+h1-1)*N+h9))*v2(((((h9-1)*N+p4-1)*N+p7-1)*N+p8))
END DO
END DO
END DO
i2(((p4-1)*N+h1))=i2(((p4-1)*N+h1))+(-0.5d0)*TMP
...
DO p7=nocc+1,N
DO p8=nocc+1,N
TMP=TMP+t3(((((((p4-1)*N+p7-1)*N+p8-1)*N+h1-1)*N+h9-1)*N+h10))*v2(((((h9-1)*N+h10-1)*N+p7-1)*N+p8))
END DO
END DO
END DO
END DO
i2(((p4-1)*N+h1))=i2(((p4-1)*N+h1))+(0.25d0)*TMP
END DO
END DO
i3(1)=0.0d0
TMP=0.0d0
DO h8=1,nocc
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h8))*f1(((h8-1)*N+p7))
END DO
END DO
i3(1)=i3(1)+(1.0d0)*TMP
TMP=0.0d0
...
DO p7=nocc+1,N
DO p8=nocc+1,N
TMP=TMP+t2(((((p7-1)*N+p8-1)*N+h9-1)*N+h10))*v2(((((h9-1)*N+h10-1)*N+p7-1)*N+p8))
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
TMP=0.0d0
TMP=TMP+t1(((p4-1)*N+h1))*i3(1)
i2(((p4-1)*N+h1))=i2(((p4-1)*N+h1))+(0.3333333333333333d0)*TMP
END DO
END DO
DO p4=nocc+1,N
DO p5=nocc+1,N
...
DO h2=1,nocc
TMP=0.0d0
TMP=TMP+t1(((p4-1)*N+h1))*i2(((p5-1)*N+h2))
i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))=i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))+(0.5d0)*TMP
i1(((((p4-1)*N+p5-1)*N+h2-1)*N+h1))=i1(((((p4-1)*N+p5-1)*N+h2-1)*N+h1))+(-0.5d0)*TMP
i1(((((p5-1)*N+p4-1)*N+h1-1)*N+h2))=i1(((((p5-1)*N+p4-1)*N+h1-1)*N+h2))+(-0.5d0)*TMP
i1(((((p5-1)*N+p4-1)*N+h2-1)*N+h1))=i1(((((p5-1)*N+p4-1)*N+h2-1)*N+h1))+(0.5d0)*TMP
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO h2=1,nocc
i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))=0.0d0
END DO
END DO
END DO
END DO
...
DO h2=1,nocc
TMP=0.0d0
TMP=TMP+v2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))
i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))=i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO h2=1,nocc
i3(((((h7-1)*N+h8-1)*N+h1-1)*N+h2))=0.0d0
END DO
END DO
END DO
END DO
...
DO h2=1,nocc
TMP=0.0d0
TMP=TMP+v2(((((h7-1)*N+h8-1)*N+h1-1)*N+h2))
i3(((((h7-1)*N+h8-1)*N+h1-1)*N+h2))=i3(((((h7-1)*N+h8-1)*N+h1-1)*N+h2))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p9=nocc+1,N
TMP=TMP+t1(((p9-1)*N+h1))*v2(((((h7-1)*N+h8-1)*N+h2-1)*N+p9))
END DO
i3(((((h7-1)*N+h8-1)*N+h1-1)*N+h2))=i3(((((h7-1)*N+h8-1)*N+h1-1)*N+h2))+(-1.0d0)*TMP
i3(((((h7-1)*N+h8-1)*N+h2-1)*N+h1))=i3(((((h7-1)*N+h8-1)*N+h2-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO p9=nocc+1,N
DO p10=nocc+1,N
TMP=TMP+t2(((((p9-1)*N+p10-1)*N+h1-1)*N+h2))*v2(((((h7-1)*N+h8-1)*N+p9-1)*N+p10))
END DO
END DO
i3(((((h7-1)*N+h8-1)*N+h1-1)*N+h2))=i3(((((h7-1)*N+h8-1)*N+h1-1)*N+h2))+(0.5d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO h8=1,nocc
TMP=TMP+t1(((p4-1)*N+h8))*i3(((((h7-1)*N+h8-1)*N+h1-1)*N+h2))
END DO
i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))=i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))+(-0.5d0)*TMP
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p8=nocc+1,N
i3(((((h7-1)*N+p4-1)*N+h1-1)*N+p8))=0.0d0
END DO
END DO
END DO
END DO
...
DO p8=nocc+1,N
TMP=0.0d0
TMP=TMP+v2(((((h7-1)*N+p4-1)*N+h1-1)*N+p8))
i3(((((h7-1)*N+p4-1)*N+h1-1)*N+p8))=i3(((((h7-1)*N+p4-1)*N+h1-1)*N+p8))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p9=nocc+1,N
TMP=TMP+t1(((p9-1)*N+h1))*v2(((((h7-1)*N+p4-1)*N+p8-1)*N+p9))
END DO
i3(((((h7-1)*N+p4-1)*N+h1-1)*N+p8))=i3(((((h7-1)*N+p4-1)*N+h1-1)*N+p8))+(-0.5d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p8=nocc+1,N
TMP=TMP+t1(((p8-1)*N+h1))*i3(((((h7-1)*N+p4-1)*N+h2-1)*N+p8))
END DO
i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))=i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))+(-1.0d0)*TMP
i2(((((h7-1)*N+p4-1)*N+h2-1)*N+h1))=i2(((((h7-1)*N+p4-1)*N+h2-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p11=nocc+1,N
i3(((((h7-1)*N+h12-1)*N+h1-1)*N+p11))=0.0d0
END DO
END DO
END DO
END DO
...
DO p11=nocc+1,N
TMP=0.0d0
TMP=TMP+v2(((((h7-1)*N+h12-1)*N+h1-1)*N+p11))
i3(((((h7-1)*N+h12-1)*N+h1-1)*N+p11))=i3(((((h7-1)*N+h12-1)*N+h1-1)*N+p11))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p8=nocc+1,N
TMP=TMP+t1(((p8-1)*N+h1))*v2(((((h7-1)*N+h12-1)*N+p8-1)*N+p11))
END DO
i3(((((h7-1)*N+h12-1)*N+h1-1)*N+p11))=i3(((((h7-1)*N+h12-1)*N+h1-1)*N+p11))+(1.0d0)*TMP
END DO
END DO
...
DO h12=1,nocc
DO p11=nocc+1,N
TMP=TMP+t2(((((p4-1)*N+p11-1)*N+h1-1)*N+h12))*i3(((((h7-1)*N+h12-1)*N+h2-1)*N+p11))
END DO
END DO
i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))=i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))+(-1.0d0)*TMP
i2(((((h7-1)*N+p4-1)*N+h2-1)*N+h1))=i2(((((h7-1)*N+p4-1)*N+h2-1)*N+h1))+(1.0d0)*TMP
...
DO p8=nocc+1,N
DO p9=nocc+1,N
TMP=TMP+t2(((((p8-1)*N+p9-1)*N+h1-1)*N+h2))*v2(((((h7-1)*N+p4-1)*N+p8-1)*N+p9))
END DO
END DO
i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))=i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))+(0.5d0)*TMP
END DO
...
DO p8=nocc+1,N
DO p9=nocc+1,N
TMP=TMP+t3(((((((p4-1)*N+p8-1)*N+p9-1)*N+h1-1)*N+h2-1)*N+h10))*v2(((((h7-1)*N+h10-1)*N+p8-1)*N+p9))
END DO
END DO
END DO
i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))=i2(((((h7-1)*N+p4-1)*N+h1-1)*N+h2))+(-0.5d0)*TMP
...
TMP=0.0d0
DO h7=1,nocc
TMP=TMP+t1(((p4-1)*N+h7))*i2(((((h7-1)*N+p5-1)*N+h1-1)*N+h2))
END DO
i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))=i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))+(-1.0d0)*TMP
i1(((((p5-1)*N+p4-1)*N+h1-1)*N+h2))=i1(((((p5-1)*N+p4-1)*N+h1-1)*N+h2))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p7=nocc+1,N
i2(((((p4-1)*N+p5-1)*N+h1-1)*N+p7))=0.0d0
END DO
END DO
END DO
END DO
...
DO p7=nocc+1,N
TMP=0.0d0
TMP=TMP+v2(((((p4-1)*N+p5-1)*N+h1-1)*N+p7))
i2(((((p4-1)*N+p5-1)*N+h1-1)*N+p7))=i2(((((p4-1)*N+p5-1)*N+h1-1)*N+p7))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p8=nocc+1,N
TMP=TMP+t1(((p8-1)*N+h1))*v2(((((p4-1)*N+p5-1)*N+p7-1)*N+p8))
END DO
i2(((((p4-1)*N+p5-1)*N+h1-1)*N+p7))=i2(((((p4-1)*N+p5-1)*N+h1-1)*N+p7))+(-0.5d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h1))*i2(((((p4-1)*N+p5-1)*N+h2-1)*N+p7))
END DO
i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))=i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))+(-1.0d0)*TMP
i1(((((p4-1)*N+p5-1)*N+h2-1)*N+h1))=i1(((((p4-1)*N+p5-1)*N+h2-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
TMP=0.0d0
TMP=TMP+f1(((h12-1)*N+h1))
i2(((h12-1)*N+h1))=i2(((h12-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
DO h12=1,nocc
DO p7=nocc+1,N
...
i3(((h12-1)*N+p7))=i3(((h12-1)*N+p7))+(1.0d0)*TMP
END DO
END DO
DO h12=1,nocc
DO p7=nocc+1,N
...
TMP=0.0d0
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h1))*i3(((h12-1)*N+p7))
END DO
i2(((h12-1)*N+h1))=i2(((h12-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
...
DO h8=1,nocc
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h8))*v2(((((h8-1)*N+h12-1)*N+h1-1)*N+p7))
END DO
END DO
i2(((h12-1)*N+h1))=i2(((h12-1)*N+h1))+(-1.0d0)*TMP
END DO
...
DO p8=nocc+1,N
DO p9=nocc+1,N
TMP=TMP+t2(((((p8-1)*N+p9-1)*N+h1-1)*N+h10))*v2(((((h10-1)*N+h12-1)*N+p8-1)*N+p9))
END DO
END DO
END DO
i2(((h12-1)*N+h1))=i2(((h12-1)*N+h1))+(-0.5d0)*TMP
END DO
END DO
DO p4=nocc+1,N
DO p5=nocc+1,N
...
TMP=0.0d0
DO h12=1,nocc
TMP=TMP+t2(((((p4-1)*N+p5-1)*N+h1-1)*N+h12))*i2(((h12-1)*N+h2))
END DO
i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))=i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))+(-1.0d0)*TMP
i1(((((p4-1)*N+p5-1)*N+h2-1)*N+h1))=i1(((((p4-1)*N+p5-1)*N+h2-1)*N+h1))+(1.0d0)*TMP
END DO
...
DO p12=nocc+1,N
TMP=0.0d0
TMP=TMP+f1(((p4-1)*N+p12))
i2(((p4-1)*N+p12))=i2(((p4-1)*N+p12))+(1.0d0)*TMP
END DO
END DO
DO h7=1,nocc
DO p12=nocc+1,N
...
DO p12=nocc+1,N
TMP=0.0d0
TMP=TMP+f1(((h7-1)*N+p12))
i3(((h7-1)*N+p12))=i3(((h7-1)*N+p12))+(1.0d0)*TMP
END DO
END DO
DO h7=1,nocc
DO p12=nocc+1,N
...
DO h9=1,nocc
DO p8=nocc+1,N
TMP=TMP+t1(((p8-1)*N+h9))*v2(((((h7-1)*N+h9-1)*N+p8-1)*N+p12))
END DO
END DO
i3(((h7-1)*N+p12))=i3(((h7-1)*N+p12))+(-1.0d0)*TMP
END DO
...
TMP=0.0d0
DO h7=1,nocc
TMP=TMP+t1(((p4-1)*N+h7))*i3(((h7-1)*N+p12))
END DO
i2(((p4-1)*N+p12))=i2(((p4-1)*N+p12))+(-1.0d0)*TMP
END DO
END DO
...
DO h8=1,nocc
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h8))*v2(((((h8-1)*N+p4-1)*N+p7-1)*N+p12))
END DO
END DO
i2(((p4-1)*N+p12))=i2(((p4-1)*N+p12))+(1.0d0)*TMP
END DO
...
DO h10=1,nocc
DO p8=nocc+1,N
TMP=TMP+t2(((((p4-1)*N+p8-1)*N+h9-1)*N+h10))*v2(((((h9-1)*N+h10-1)*N+p8-1)*N+p12))
END DO
END DO
END DO
i2(((p4-1)*N+p12))=i2(((p4-1)*N+p12))+(0.5d0)*TMP
END DO
END DO
DO p4=nocc+1,N
DO p5=nocc+1,N
...
TMP=0.0d0
DO p12=nocc+1,N
TMP=TMP+t2(((((p4-1)*N+p12-1)*N+h1-1)*N+h2))*i2(((p5-1)*N+p12))
END DO
i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))=i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))+(1.0d0)*TMP
i1(((((p5-1)*N+p4-1)*N+h1-1)*N+h2))=i1(((((p5-1)*N+p4-1)*N+h1-1)*N+h2))+(-1.0d0)*TMP
END DO
...
DO h1=1,nocc
DO h2=1,nocc
i2(((((h11-1)*N+h12-1)*N+h1-1)*N+h2))=0.0d0
END DO
END DO
END DO
END DO
...
i2(((((h11-1)*N+h12-1)*N+h1-1)*N+h2))=i2(((((h11-1)*N+h12-1)*N+h1-1)*N+h2))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p7=nocc+1,N
i3(((((h11-1)*N+h12-1)*N+h1-1)*N+p7))=0.0d0
END DO
END DO
END DO
END DO
...
DO p7=nocc+1,N
TMP=0.0d0
TMP=TMP+v2(((((h11-1)*N+h12-1)*N+h1-1)*N+p7))
i3(((((h11-1)*N+h12-1)*N+h1-1)*N+p7))=i3(((((h11-1)*N+h12-1)*N+h1-1)*N+p7))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p8=nocc+1,N
TMP=TMP+t1(((p8-1)*N+h1))*v2(((((h11-1)*N+h12-1)*N+p7-1)*N+p8))
END DO
i3(((((h11-1)*N+h12-1)*N+h1-1)*N+p7))=i3(((((h11-1)*N+h12-1)*N+h1-1)*N+p7))+(-0.5d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h1))*i3(((((h11-1)*N+h12-1)*N+h2-1)*N+p7))
END DO
i2(((((h11-1)*N+h12-1)*N+h1-1)*N+h2))=i2(((((h11-1)*N+h12-1)*N+h1-1)*N+h2))+(-1.0d0)*TMP
i2(((((h11-1)*N+h12-1)*N+h2-1)*N+h1))=i2(((((h11-1)*N+h12-1)*N+h2-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
END DO
END DO
i2(((((h11-1)*N+h12-1)*N+h1-1)*N+h2))=i2(((((h11-1)*N+h12-1)*N+h1-1)*N+h2))+(0.5d0)*TMP
END DO
END DO
END DO
END DO
...
DO h11=1,nocc
DO h12=1,nocc
TMP=TMP+t2(((((p4-1)*N+p5-1)*N+h11-1)*N+h12))*i2(((((h11-1)*N+h12-1)*N+h1-1)*N+h2))
END DO
END DO
i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))=i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))+(0.5d0)*TMP
END DO
...
DO h1=1,nocc
DO p12=nocc+1,N
i2(((((h13-1)*N+p4-1)*N+h1-1)*N+p12))=0.0d0
END DO
END DO
END DO
END DO
...
DO p12=nocc+1,N
TMP=0.0d0
TMP=TMP+v2(((((h13-1)*N+p4-1)*N+h1-1)*N+p12))
i2(((((h13-1)*N+p4-1)*N+h1-1)*N+p12))=i2(((((h13-1)*N+p4-1)*N+h1-1)*N+p12))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h1))*v2(((((h13-1)*N+p4-1)*N+p7-1)*N+p12))
END DO
i2(((((h13-1)*N+p4-1)*N+h1-1)*N+p12))=i2(((((h13-1)*N+p4-1)*N+h1-1)*N+p12))+(1.0d0)*TMP
END DO
END DO
...
DO h10=1,nocc
DO p9=nocc+1,N
TMP=TMP+t2(((((p4-1)*N+p9-1)*N+h1-1)*N+h10))*v2(((((h10-1)*N+h13-1)*N+p9-1)*N+p12))
END DO
END DO
i2(((((h13-1)*N+p4-1)*N+h1-1)*N+p12))=i2(((((h13-1)*N+p4-1)*N+h1-1)*N+p12))+(-0.5d0)*TMP
END DO
END DO
END DO
END DO
...
DO h13=1,nocc
DO p12=nocc+1,N
TMP=TMP+t2(((((p4-1)*N+p12-1)*N+h1-1)*N+h13))*i2(((((h13-1)*N+p5-1)*N+h2-1)*N+p12))
END DO
END DO
i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))=i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))+(-1.0d0)*TMP
i1(((((p4-1)*N+p5-1)*N+h2-1)*N+h1))=i1(((((p4-1)*N+p5-1)*N+h2-1)*N+h1))+(1.0d0)*TMP
i1(((((p5-1)*N+p4-1)*N+h1-1)*N+h2))=i1(((((p5-1)*N+p4-1)*N+h1-1)*N+h2))+(1.0d0)*TMP
i1(((((p5-1)*N+p4-1)*N+h2-1)*N+h1))=i1(((((p5-1)*N+p4-1)*N+h2-1)*N+h1))+(-1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO p7=nocc+1,N
DO p8=nocc+1,N
TMP=TMP+t2(((((p7-1)*N+p8-1)*N+h1-1)*N+h2))*v2(((((p4-1)*N+p5-1)*N+p7-1)*N+p8))
END DO
END DO
i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))=i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))+(0.5d0)*TMP
END DO
...
TMP=0.0d0
TMP=TMP+f1(((h9-1)*N+p11))
i2(((h9-1)*N+p11))=i2(((h9-1)*N+p11))+(1.0d0)*TMP
END DO
END DO
DO h9=1,nocc
DO p11=nocc+1,N
...
DO h9=1,nocc
DO p11=nocc+1,N
TMP=TMP+t3(((((((p4-1)*N+p5-1)*N+p11-1)*N+h1-1)*N+h2-1)*N+h9))*i2(((h9-1)*N+p11))
END DO
END DO
i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))=i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))+(1.0d0)*TMP
END DO
...
DO h1=1,nocc
DO p11=nocc+1,N
i2(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))=0.0d0
END DO
END DO
END DO
END DO
...
DO p11=nocc+1,N
TMP=0.0d0
TMP=TMP+v2(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))
i2(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))=i2(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))+(-1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h1))*v2(((((h8-1)*N+h12-1)*N+p7-1)*N+p11))
END DO
i2(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))=i2(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))+(-1.0d0)*TMP
END DO
END DO
...
DO h8=1,nocc
DO p11=nocc+1,N
TMP=TMP+t3(((((((p4-1)*N+p5-1)*N+p11-1)*N+h1-1)*N+h8-1)*N+h12))*i2(((((h8-1)*N+h12-1)*N+h2-1)*N+p11))
END DO
END DO
END DO
i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))=i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))+(0.5d0)*TMP
...
DO p7=nocc+1,N
DO p8=nocc+1,N
TMP=TMP+t3(((((((p4-1)*N+p7-1)*N+p8-1)*N+h1-1)*N+h2-1)*N+h9))*v2(((((h9-1)*N+p5-1)*N+p7-1)*N+p8))
END DO
END DO
END DO
i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))=i1(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))+(-0.5d0)*TMP
...
i0(((((((p5-1)*N+p4-1)*N+p6-1)*N+h2-1)*N+h1-1)*N+h3))=i0(((((((p5-1)*N+p4-1)*N+p6-1)*N+h2-1)*N+h1-1)*N+h3))+(1.0d0)*TMP
i0(((((((p5-1)*N+p4-1)*N+p6-1)*N+h2-1)*N+h3-1)*N+h1))=i0(((((((p5-1)*N+p4-1)*N+p6-1)*N+h2-1)*N+h3-1)*N+h1))+(-1.0d0)*TMP
i0(((((((p5-1)*N+p6-1)*N+p4-1)*N+h1-1)*N+h2-1)*N+h3))=i0(((((((p5-1)*N+p6-1)*N+p4-1)*N+h1-1)*N+h2-1)*N+h3))+(1.0d0)*TMP
i0(((((((p5-1)*N+p6-1)*N+p4-1)*N+h2-1)*N+h1-1)*N+h3))=i0(((((((p5-1)*N+p6-1)*N+p4-1)*N+h2-1)*N+h1-1)*N+h3))+(-1.0d0)*TMP
i0(((((((p5-1)*N+p6-1)*N+p4-1)*N+h2-1)*N+h3-1)*N+h1))=i0(((((((p5-1)*N+p6-1)*N+p4-1)*N+h2-1)*N+h3-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
TMP=TMP+f1(((p4-1)*N+h1))
i1(((p4-1)*N+h1))=i1(((p4-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
DO h11=1,nocc
DO h1=1,nocc
...
TMP=0.0d0
TMP=TMP+f1(((h11-1)*N+h1))
i2(((h11-1)*N+h1))=i2(((h11-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
DO h11=1,nocc
DO p12=nocc+1,N
i3(((h11-1)*N+p12))=0.0d0
END DO
END DO
DO h11=1,nocc
DO p12=nocc+1,N
TMP=0.0d0
TMP=TMP+f1(((h11-1)*N+p12))
i3(((h11-1)*N+p12))=i3(((h11-1)*N+p12))+(1.0d0)*TMP
END DO
END DO
DO h11=1,nocc
DO p12=nocc+1,N
...
DO h10=1,nocc
DO p9=nocc+1,N
TMP=TMP+t1(((p9-1)*N+h10))*v2(((((h10-1)*N+h11-1)*N+p9-1)*N+p12))
END DO
END DO
i3(((h11-1)*N+p12))=i3(((h11-1)*N+p12))+(0.9999999999999998d0)*TMP
END DO
END DO
DO h11=1,nocc
DO h1=1,nocc
TMP=0.0d0
DO p12=nocc+1,N
TMP=TMP+t1(((p12-1)*N+h1))*i3(((h11-1)*N+p12))
END DO
i2(((h11-1)*N+h1))=i2(((h11-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
...
DO p7=nocc+1,N
DO p8=nocc+1,N
TMP=TMP+t2(((((p7-1)*N+p8-1)*N+h1-1)*N+h9))*v2(((((h9-1)*N+h11-1)*N+p7-1)*N+p8))
END DO
END DO
END DO
i2(((h11-1)*N+h1))=i2(((h11-1)*N+h1))+(-0.5d0)*TMP
END DO
END DO
DO p4=nocc+1,N
DO h1=1,nocc
TMP=0.0d0
DO h11=1,nocc
TMP=TMP+t1(((p4-1)*N+h11))*i2(((h11-1)*N+h1))
END DO
i1(((p4-1)*N+h1))=i1(((p4-1)*N+h1))+(-1.0d0)*TMP
END DO
END DO
...
DO p11=nocc+1,N
TMP=0.0d0
TMP=TMP+f1(((p4-1)*N+p11))
i2(((p4-1)*N+p11))=i2(((p4-1)*N+p11))+(1.0d0)*TMP
END DO
END DO
DO p4=nocc+1,N
DO p11=nocc+1,N
...
DO h9=1,nocc
DO p8=nocc+1,N
TMP=TMP+t1(((p8-1)*N+h9))*v2(((((h9-1)*N+p4-1)*N+p8-1)*N+p11))
END DO
END DO
i2(((p4-1)*N+p11))=i2(((p4-1)*N+p11))+(1.0d0)*TMP
END DO
...
DO h9=1,nocc
DO p7=nocc+1,N
TMP=TMP+t2(((((p4-1)*N+p7-1)*N+h8-1)*N+h9))*v2(((((h8-1)*N+h9-1)*N+p7-1)*N+p11))
END DO
END DO
END DO
i2(((p4-1)*N+p11))=i2(((p4-1)*N+p11))+(0.5d0)*TMP
END DO
END DO
DO p4=nocc+1,N
DO h1=1,nocc
TMP=0.0d0
DO p11=nocc+1,N
TMP=TMP+t1(((p11-1)*N+h1))*i2(((p4-1)*N+p11))
END DO
i1(((p4-1)*N+h1))=i1(((p4-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
...
i2(((h8-1)*N+p7))=i2(((h8-1)*N+p7))+(1.0d0)*TMP
END DO
END DO
DO h8=1,nocc
DO p7=nocc+1,N
...
DO h10=1,nocc
DO p9=nocc+1,N
TMP=TMP+t1(((p9-1)*N+h10))*v2(((((h8-1)*N+h10-1)*N+p7-1)*N+p9))
END DO
END DO
i2(((h8-1)*N+p7))=i2(((h8-1)*N+p7))+(1.0d0)*TMP
END DO
...
DO h8=1,nocc
DO p7=nocc+1,N
TMP=TMP+t2(((((p4-1)*N+p7-1)*N+h1-1)*N+h8))*i2(((h8-1)*N+p7))
END DO
END DO
i1(((p4-1)*N+h1))=i1(((p4-1)*N+h1))+(1.0d0)*TMP
END DO
...
END DO
END DO
i1(((p4-1)*N+h1))=i1(((p4-1)*N+h1))+(-0.5d0)*TMP
END DO
END DO
DO p4=nocc+1,N
DO h1=1,nocc
...
END DO
END DO
i1(((p4-1)*N+h1))=i1(((p4-1)*N+h1))+(0.25d0)*TMP
END DO
END DO
DO h8=1,nocc
DO p7=nocc+1,N
...
TMP=0.0d0
TMP=TMP+f1(((h8-1)*N+p7))
i3(((h8-1)*N+p7))=i3(((h8-1)*N+p7))+(1.0d0)*TMP
END DO
END DO
DO h8=1,nocc
DO p7=nocc+1,N
...
END DO
END DO
i3(((h8-1)*N+p7))=i3(((h8-1)*N+p7))+(0.5d0)*TMP
END DO
END DO
i2(1)=0.0d0
TMP=0.0d0
DO h8=1,nocc
DO p7=nocc+1,N
TMP=TMP+t1(((p7-1)*N+h8))*i3(((h8-1)*N+p7))
END DO
END DO
i2(1)=i2(1)+(1.0d0)*TMP
TMP=0.0d0
...
DO h3=1,nocc
TMP=0.0d0
TMP=TMP+t2(((((p4-1)*N+p5-1)*N+h1-1)*N+h2))*i1(((p6-1)*N+h3))
i0(((((((p4-1)*N+p5-1)*N+p6-1)*N+h1-1)*N+h2-1)*N+h3))=i0(((((((p4-1)*N+p5-1)*N+p6-1)*N+h1-1)*N+h2-1)*N+h3))+(1.0d0)*TMP
...
DO h1=1,nocc
DO h2=1,nocc
i2(((((h7-1)*N+h11-1)*N+h1-1)*N+h2))=0.0d0
END DO
END DO
END DO
END DO
...
DO h2=1,nocc
TMP=0.0d0
TMP=TMP+v2(((((h7-1)*N+h11-1)*N+h1-1)*N+h2))
i2(((((h7-1)*N+h11-1)*N+h1-1)*N+h2))=i2(((((h7-1)*N+h11-1)*N+h1-1)*N+h2))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p8=nocc+1,N
i3(((((h7-1)*N+h11-1)*N+h1-1)*N+p8))=0.0d0
END DO
END DO
END DO
END DO
...
DO p8=nocc+1,N
TMP=0.0d0
TMP=TMP+v2(((((h7-1)*N+h11-1)*N+h1-1)*N+p8))
i3(((((h7-1)*N+h11-1)*N+h1-1)*N+p8))=i3(((((h7-1)*N+h11-1)*N+h1-1)*N+p8))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p9=nocc+1,N
TMP=TMP+t1(((p9-1)*N+h1))*v2(((((h7-1)*N+h11-1)*N+p8-1)*N+p9))
END DO
i3(((((h7-1)*N+h11-1)*N+h1-1)*N+p8))=i3(((((h7-1)*N+h11-1)*N+h1-1)*N+p8))+(-0.4999999999999999d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p8=nocc+1,N
TMP=TMP+t1(((p8-1)*N+h1))*i3(((((h7-1)*N+h11-1)*N+h2-1)*N+p8))
END DO
i2(((((h7-1)*N+h11-1)*N+h1-1)*N+h2))=i2(((((h7-1)*N+h11-1)*N+h1-1)*N+h2))+(-1.0d0)*TMP
i2(((((h7-1)*N+h11-1)*N+h2-1)*N+h1))=i2(((((h7-1)*N+h11-1)*N+h2-1)*N+h1))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO p8=nocc+1,N
DO p9=nocc+1,N
TMP=TMP+t2(((((p8-1)*N+p9-1)*N+h1-1)*N+h2))*v2(((((h7-1)*N+h11-1)*N+p8-1)*N+p9))
END DO
END DO
i2(((((h7-1)*N+h11-1)*N+h1-1)*N+h2))=i2(((((h7-1)*N+h11-1)*N+h1-1)*N+h2))+(0.5d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO h7=1,nocc
TMP=TMP+t1(((p4-1)*N+h7))*i2(((((h7-1)*N+h11-1)*N+h1-1)*N+h2))
END DO
i1(((((h11-1)*N+p4-1)*N+h1-1)*N+h2))=i1(((((h11-1)*N+p4-1)*N+h1-1)*N+h2))+(1.0d0)*TMP
END DO
END DO
...
TMP=0.0d0
TMP=TMP+f1(((h11-1)*N+p12))
i2(((h11-1)*N+p12))=i2(((h11-1)*N+p12))+(1.0d0)*TMP
END DO
END DO
DO h11=1,nocc
DO p12=nocc+1,N
...
TMP=0.0d0
DO p12=nocc+1,N
TMP=TMP+t2(((((p4-1)*N+p12-1)*N+h1-1)*N+h2))*i2(((h11-1)*N+p12))
END DO
i1(((((h11-1)*N+p4-1)*N+h1-1)*N+h2))=i1(((((h11-1)*N+p4-1)*N+h1-1)*N+h2))+(-1.0d0)*TMP
END DO
END DO
...
DO h1=1,nocc
DO p11=nocc+1,N
i2(((((h12-1)*N+p4-1)*N+h1-1)*N+p11))=0.0d0
END DO
END DO
END DO
END DO
...
DO p11=nocc+1,N
TMP=0.0d0
TMP=TMP+v2(((((h12-1)*N+p4-1)*N+h1-1)*N+p11))
i2(((((h12-1)*N+p4-1)*N+h1-1)*N+p11))=i2(((((h12-1)*N+p4-1)*N+h1-1)*N+p11))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p11=nocc+1,N
i3(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))=0.0d0
END DO
END DO
END DO
END DO
...
TMP=0.0d0
TMP=TMP+v2(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))
i3(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))=i3(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p9=nocc+1,N
TMP=TMP+t1(((p9-1)*N+h1))*v2(((((h8-1)*N+h12-1)*N+p9-1)*N+p11))
END DO
i3(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))=i3(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))+(1.0d0)*TMP
END DO
END DO
...
TMP=0.0d0
DO h8=1,nocc
TMP=TMP+t1(((p4-1)*N+h8))*i3(((((h8-1)*N+h12-1)*N+h1-1)*N+p11))
END DO
i2(((((h12-1)*N+p4-1)*N+h1-1)*N+p11))=i2(((((h12-1)*N+p4-1)*N+h1-1)*N+p11))+(0.5d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p8=nocc+1,N
TMP=TMP+t1(((p8-1)*N+h1))*v2(((((h12-1)*N+p4-1)*N+p8-1)*N+p11))
END DO
i2(((((h12-1)*N+p4-1)*N+h1-1)*N+p11))=i2(((((h12-1)*N+p4-1)*N+h1-1)*N+p11))+(1.0d0)*TMP
END DO
END DO
...
DO h9=1,nocc
DO p8=nocc+1,N
TMP=TMP+t2(((((p4-1)*N+p8-1)*N+h1-1)*N+h9))*v2(((((h9-1)*N+h12-1)*N+p8-1)*N+p11))
END DO
END DO
i2(((((h12-1)*N+p4-1)*N+h1-1)*N+p11))=i2(((((h12-1)*N+p4-1)*N+h1-1)*N+p11))+(-1.0d0)*TMP
END DO
...
TMP=0.0d0
DO p11=nocc+1,N
TMP=TMP+t2(((((p4-1)*N+p11-1)*N+h1-1)*N+h2))*i2(((((h12-1)*N+p5-1)*N+h3-1)*N+p11))
END DO
...
DO h1=1,nocc
DO p11=nocc+1,N
i2(((((h7-1)*N+h12-1)*N+h1-1)*N+p11))=0.0d0
END DO
END DO
END DO
END DO
...
TMP=0.0d0
TMP=TMP+v2(((((h7-1)*N+h12-1)*N+h1-1)*N+p11))
i2(((((h7-1)*N+h12-1)*N+h1-1)*N+p11))=i2(((((h7-1)*N+h12-1)*N+h1-1)*N+p11))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO h7=1,nocc
DO p11=nocc+1,N
TMP=TMP+t3(((((((p4-1)*N+p5-1)*N+p11-1)*N+h1-1)*N+h2-1)*N+h7))*i2(((((h7-1)*N+h12-1)*N+h3-1)*N+p11))
END DO
END DO
...
&4d0)*TMP
i1(((((((h12-1)*N+p5-1)*N+p4-1)*N+h1-1)*N+h2-1)*N+h3))=i1(((((((h12-1)*N+p5-1)*N+p4-1)*N+h1-1)*N+h2-1)*N+h3))+(0.041666666666666664&
&d0)*TMP
END DO
END DO
END DO
...
DO h12=1,nocc
DO p11=nocc+1,N
i2(((h12-1)*N+p11))=0.0d0
END DO
END DO
DO h12=1,nocc
DO p11=nocc+1,N
TMP=0.0d0
TMP=TMP+f1(((h12-1)*N+p11))
i2(((h12-1)*N+p11))=i2(((h12-1)*N+p11))+(1.0d0)*TMP
END DO
END DO
DO h12=1,nocc
DO p11=nocc+1,N
...
DO h10=1,nocc
DO p9=nocc+1,N
TMP=TMP+t1(((p9-1)*N+h10))*v2(((((h10-1)*N+h12-1)*N+p9-1)*N+p11))
END DO
END DO
i2(((h12-1)*N+p11))=i2(((h12-1)*N+p11))+(0.5d0)*TMP
END DO
END DO
i1(1)=0.0d0
TMP=0.0d0
DO h12=1,nocc
DO p11=nocc+1,N
TMP=TMP+t1(((p11-1)*N+h12))*i2(((h12-1)*N+p11))
END DO
END DO
i1(1)=i1(1)+(1.0d0)*TMP
TMP=0.0d0
...
DO h3=1,nocc
TMP=0.0d0
TMP=TMP+t3(((((((p4-1)*N+p5-1)*N+p6-1)*N+h1-1)*N+h2-1)*N+h3))*i1(1)
i0(((((((p4-1)*N+p5-1)*N+p6-1)*N+h1-1)*N+h2-1)*N+h3))=i0(((((((p4-1)*N+p5-1)*N+p6-1)*N+h1-1)*N+h2-1)*N+h3))+(1.0d0)*TMP
END DO
END DO
END DO
