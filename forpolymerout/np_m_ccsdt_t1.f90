SUBROUTINE np_m_ccsdt_t1(N,f1,i0,i1,i2,m,nocc,t1,t2,t3,v2)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p2
...
DO h7=1,nocc
DO p3=nocc+1,N
i2(((m(h7)-1)*N+m(p3)))=0.0d0
END DO
END DO
DO h7=1,nocc
DO p3=nocc+1,N
TMP=0.0d0
TMP=TMP+f1(((m(h7)-1)*N+m(p3)))
i2(((m(h7)-1)*N+m(p3)))=i2(((m(h7)-1)*N+m(p3)))+(1.0d0)*TMP
END DO
END DO
DO h7=1,nocc
DO p3=nocc+1,N
...
DO h6=1,nocc
DO p5=nocc+1,N
TMP=TMP+t1(((m(p5)-1)*N+m(h6)))*v2(((((m(h6)-1)*N+m(h7)-1)*N+m(p3)-1)*N+m(p5)))
END DO
END DO
i2(((m(h7)-1)*N+m(p3)))=i2(((m(h7)-1)*N+m(p3)))+(-1.0d0)*TMP
END DO
...
TMP=0.0d0
DO p3=nocc+1,N
TMP=TMP+t1(((m(p3)-1)*N+m(h1)))*i2(((m(h7)-1)*N+m(p3)))
END DO
i1(((m(h7)-1)*N+m(h1)))=i1(((m(h7)-1)*N+m(h1)))+(1.0d0)*TMP
END DO
END DO
...
DO p3=nocc+1,N
DO p4=nocc+1,N
TMP=TMP+t3(((((((m(p2)-1)*N+m(p3)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h5)-1)*N+m(h6)))*v2(((((m(h5)-1)*N+m(h6)-1)*N+m(p3)-1)*N+m(p4)))
END DO
END DO
END DO
END DO
i0(((m(p2)-1)*N+m(h1)))=i0(((m(p2)-1)*N+m(h1)))+(0.25d0)*TMP
END DO
END DO
DO p2=nocc+1,N
DO h1=1,nocc
