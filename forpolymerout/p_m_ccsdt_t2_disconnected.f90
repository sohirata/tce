SUBROUTINE p_m_ccsdt_t2_disconnected(N,f1,f1e,i0,i0e,i1,i1e,i2,i2e,i3,i3e,m,nocc,t1,t1e,t2,t2e,t3,t3e,v2,v2e)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p3
...
IF (h1>h7) CYCLE
IF (h7>h8) CYCLE
t3e(((((((m(p5)-1)*N+m(p3)-1)*N+m(p6)-1)*N+m(h7)-1)*N+m(h1)-1)*N+m(h8)))= + t3(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(&
&h7)-1)*N+m(h8)))
t3e(((((((m(p5)-1)*N+m(p3)-1)*N+m(p6)-1)*N+m(h8)-1)*N+m(h1)-1)*N+m(h7)))= - t3(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(&
&h7)-1)*N+m(h8)))
t3e(((((((m(p5)-1)*N+m(p3)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(h7)-1)*N+m(h8)))= - t3(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(&
&h7)-1)*N+m(h8)))
t3e(((((((m(p6)-1)*N+m(p3)-1)*N+m(p5)-1)*N+m(h7)-1)*N+m(h1)-1)*N+m(h8)))= - t3(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(&
&h7)-1)*N+m(h8)))
t3e(((((((m(p6)-1)*N+m(p3)-1)*N+m(p5)-1)*N+m(h8)-1)*N+m(h1)-1)*N+m(h7)))= + t3(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(&
&h7)-1)*N+m(h8)))
t3e(((((((m(p6)-1)*N+m(p3)-1)*N+m(p5)-1)*N+m(h1)-1)*N+m(h7)-1)*N+m(h8)))= + t3(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(&
&h7)-1)*N+m(h8)))
t3e(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h7)-1)*N+m(h1)-1)*N+m(h8)))= - t3(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(&
&h7)-1)*N+m(h8)))
t3e(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h8)-1)*N+m(h1)-1)*N+m(h7)))= + t3(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(&
&h7)-1)*N+m(h8)))
t3e(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(h7)-1)*N+m(h8)))= + t3(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(&
&h7)-1)*N+m(h8)))
END DO
END DO
END DO
...
DO h8=1,nocc
IF (h7>h8) CYCLE
i1(((m(p3)-1)*N+m(h1)))=i1(((m(p3)-1)*N+m(h1)))+(1.0d0)*t3e(((((((m(p3)-1)*N+m(p5)-1)*N+m(p6)-1)*N+m(h1)-1)*N+m(h7)-1)*N+m(h8)))*v2&
&(((((m(h7)-1)*N+m(h8)-1)*N+m(p5)-1)*N+m(p6)))
END DO
END DO
END DO
END DO
...
IF (p5>p6) CYCLE
DO h7=1,nocc
i1(((((m(h9)-1)*N+m(p3)-1)*N+m(h1)-1)*N+m(h2)))=i1(((((m(h9)-1)*N+m(p3)-1)*N+m(h1)-1)*N+m(h2)))+(1.0d0)*t3e(((((((m(p3)-1)*N+m(p5)-&
&1)*N+m(p6)-1)*N+m(h1)-1)*N+m(h2)-1)*N+m(h7)))*v2e(((((m(h7)-1)*N+m(h9)-1)*N+m(p5)-1)*N+m(p6)))
END DO
END DO
END DO
END DO
