SUBROUTINE np_m_ccsdt_t3(N,f1,i0,i1,i2,i3,m,nocc,t1,t2,t3,v2)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p4
...
DO h1=1,nocc
DO p7=nocc+1,N
i3(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7)))=0.0d0
END DO
END DO
END DO
END DO
...
DO p7=nocc+1,N
TMP=0.0d0
TMP=TMP+v2(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7)))
i3(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7)))=i3(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7)))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p8=nocc+1,N
TMP=TMP+t1(((m(p8)-1)*N+m(h1)))*v2(((((m(h10)-1)*N+m(h11)-1)*N+m(p7)-1)*N+m(p8)))
END DO
i3(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7)))=i3(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(p7)))+(-0.5d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p7=nocc+1,N
TMP=TMP+t1(((m(p7)-1)*N+m(h1)))*i3(((((m(h10)-1)*N+m(h11)-1)*N+m(h2)-1)*N+m(p7)))
END DO
i2(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(h2)))=i2(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(h2)))+(-1.0d0)*TMP
...
DO p8=nocc+1,N
DO p9=nocc+1,N
TMP=TMP+t2(((((m(p8)-1)*N+m(p9)-1)*N+m(h1)-1)*N+m(h2)))*v2(((((m(h10)-1)*N+m(h11)-1)*N+m(p8)-1)*N+m(p9)))
END DO
END DO
...
TMP=0.0d0
DO h10=1,nocc
TMP=TMP+t1(((m(p4)-1)*N+m(h10)))*i2(((((m(h10)-1)*N+m(h11)-1)*N+m(h1)-1)*N+m(h2)))
END DO
i1(((((m(h11)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))=i1(((((m(h11)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))+(1.0d0)*TMP
END DO
END DO
...
DO h11=1,nocc
DO p7=nocc+1,N
i2(((m(h11)-1)*N+m(p7)))=0.0d0
END DO
END DO
DO h11=1,nocc
DO p7=nocc+1,N
TMP=0.0d0
TMP=TMP+f1(((m(h11)-1)*N+m(p7)))
i2(((m(h11)-1)*N+m(p7)))=i2(((m(h11)-1)*N+m(p7)))+(1.0d0)*TMP
END DO
END DO
DO h11=1,nocc
DO p7=nocc+1,N
...
DO h10=1,nocc
DO p9=nocc+1,N
TMP=TMP+t1(((m(p9)-1)*N+m(h10)))*v2(((((m(h10)-1)*N+m(h11)-1)*N+m(p7)-1)*N+m(p9)))
END DO
END DO
i2(((m(h11)-1)*N+m(p7)))=i2(((m(h11)-1)*N+m(p7)))+(-1.0d0)*TMP
END DO
...
TMP=0.0d0
DO p7=nocc+1,N
TMP=TMP+t2(((((m(p4)-1)*N+m(p7)-1)*N+m(h1)-1)*N+m(h2)))*i2(((m(h11)-1)*N+m(p7)))
END DO
i1(((((m(h11)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))=i1(((((m(h11)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))+(-1.0d0)*TMP
END DO
END DO
...
DO h1=1,nocc
DO p10=nocc+1,N
i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))=0.0d0
END DO
END DO
END DO
END DO
...
DO p10=nocc+1,N
TMP=0.0d0
TMP=TMP+v2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))
i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))=i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
DO h1=1,nocc
DO p10=nocc+1,N
i3(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))=0.0d0
END DO
END DO
END DO
END DO
...
TMP=0.0d0
TMP=TMP+v2(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))
i3(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))=i3(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p7=nocc+1,N
TMP=TMP+t1(((m(p7)-1)*N+m(h1)))*v2(((((m(h11)-1)*N+m(h12)-1)*N+m(p7)-1)*N+m(p10)))
END DO
i3(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))=i3(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))+(1.0d0)*TMP
END DO
END DO
...
TMP=0.0d0
DO h11=1,nocc
TMP=TMP+t1(((m(p4)-1)*N+m(h11)))*i3(((((m(h11)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p10)))
END DO
i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))=i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))+(0.5d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p7=nocc+1,N
TMP=TMP+t1(((m(p7)-1)*N+m(h1)))*v2(((((m(h12)-1)*N+m(p4)-1)*N+m(p7)-1)*N+m(p10)))
END DO
i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))=i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))+(1.0d0)*TMP
END DO
END DO
...
DO h9=1,nocc
DO p8=nocc+1,N
TMP=TMP+t2(((((m(p4)-1)*N+m(p8)-1)*N+m(h1)-1)*N+m(h9)))*v2(((((m(h9)-1)*N+m(h12)-1)*N+m(p8)-1)*N+m(p10)))
END DO
END DO
i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))=i2(((((m(h12)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p10)))+(-1.0d0)*TMP
END DO
...
TMP=0.0d0
DO p10=nocc+1,N
TMP=TMP+t2(((((m(p4)-1)*N+m(p10)-1)*N+m(h1)-1)*N+m(h2)))*i2(((((m(h12)-1)*N+m(p5)-1)*N+m(h3)-1)*N+m(p10)))
END DO
...
DO h1=1,nocc
DO p11=nocc+1,N
i2(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))=0.0d0
END DO
END DO
END DO
END DO
...
DO p11=nocc+1,N
TMP=0.0d0
TMP=TMP+v2(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))
i2(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))=i2(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))+(1.0d0)*TMP
END DO
END DO
END DO
END DO
...
TMP=0.0d0
DO p7=nocc+1,N
TMP=TMP+t1(((m(p7)-1)*N+m(h1)))*v2(((((m(h9)-1)*N+m(h12)-1)*N+m(p7)-1)*N+m(p11)))
END DO
i2(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))=i2(((((m(h9)-1)*N+m(h12)-1)*N+m(h1)-1)*N+m(p11)))+(1.0d0)*TMP
END DO
END DO
...
DO h9=1,nocc
DO p11=nocc+1,N
TMP=TMP+t3(((((((m(p4)-1)*N+m(p5)-1)*N+m(p11)-1)*N+m(h1)-1)*N+m(h2)-1)*N+m(h9)))*i2(((((m(h9)-1)*N+m(h12)-1)*N+m(h3)-1)*N+m(p11)))
END DO
END DO
i1(((((((m(h12)-1)*N+m(p4)-1)*N+m(p5)-1)*N+m(h1)-1)*N+m(h2)-1)*N+m(h3)))=i1(((((((m(h12)-1)*N+m(p4)-1)*N+m(p5)-1)*N+m(h1)-1)*N+m(h2&
&)-1)*N+m(h3)))+(0.16666666666666666d0)*TMP
