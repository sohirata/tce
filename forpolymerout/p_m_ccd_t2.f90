SUBROUTINE p_m_ccd_t2(N,f1,f1e,i0,i0e,i1,i1e,m,nocc,t2,t2e,v2,v2e)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p3
...
DO h2=1,nocc
IF (h1>h2) CYCLE
i1(((((m(h7)-1)*N+m(h9)-1)*N+m(h1)-1)*N+m(h2)))=(-1.0d0)*v2(((((m(h7)-1)*N+m(h9)-1)*N+m(h1)-1)*N+m(h2)))
END DO
END DO
END DO
END DO
...
DO p6=nocc+1,N
IF (p5>p6) CYCLE
i1(((((m(h7)-1)*N+m(h9)-1)*N+m(h1)-1)*N+m(h2)))=i1(((((m(h7)-1)*N+m(h9)-1)*N+m(h1)-1)*N+m(h2)))+(-1.0d0)*t2(((((m(p5)-1)*N+m(p6)-1)&
&*N+m(h1)-1)*N+m(h2)))*v2(((((m(h7)-1)*N+m(h9)-1)*N+m(p5)-1)*N+m(p6)))
END DO
END DO
END DO
END DO
...
&*N+m(h7)-1)*N+m(h9)))*i1(((((m(h7)-1)*N+m(h9)-1)*N+m(h1)-1)*N+m(h2)))
END DO
END DO
END DO
END DO
