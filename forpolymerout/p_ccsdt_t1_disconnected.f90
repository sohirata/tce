SUBROUTINE p_ccsdt_t1_disconnected(N,f1,f1e,i0,i0e,i1,i1e,i2,i2e,nocc,t1,t1e,t2,t2e,t3,t3e,v2,v2e)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p2
...
DO h4=1,nocc
DO p3=nocc+1,N
i2(((h4-1)*N+p3))=(1.0d0)*f1(((h4-1)*N+p3))
END DO
END DO
DO h4=1,nocc
DO h6=1,nocc
...
DO p5=nocc+1,N
DO h6=1,nocc
i2(((h4-1)*N+p3))=i2(((h4-1)*N+p3))+(0.5d0)*t1(((p5-1)*N+h6))*v2e(((((h4-1)*N+h6-1)*N+p3-1)*N+p5))
END DO
END DO
END DO
END DO
...
DO p3=nocc+1,N
DO h4=1,nocc
i1(1)=i1(1)+(1.0d0)*t1(((p3-1)*N+h4))*i2(((h4-1)*N+p3))
END DO
END DO
DO p3=nocc+1,N
DO p4=nocc+1,N
...
DO h6=1,nocc
IF (h5>h6) CYCLE
i1(1)=i1(1)+(1.0d0)*t2(((((p3-1)*N+p4-1)*N+h5-1)*N+h6))*v2(((((h5-1)*N+h6-1)*N+p3-1)*N+p4))
END DO
END DO
END DO
END DO
DO p2=nocc+1,N
DO h1=1,nocc
i0(((p2-1)*N+h1))=i0(((p2-1)*N+h1))+(1.0d0)*t1(((p2-1)*N+h1))*i1(1)
END DO
END DO
RETURN
END SUBROUTINE
