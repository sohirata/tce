SUBROUTINE p_m_lccsd_t2(N,f1,f1e,i0,i0e,m,nocc,t1,t1e,t2,t2e,v2,v2e)
IMPLICIT NONE
INTEGER :: N
INTEGER :: nocc
INTEGER :: p3
...
DO h2=1,nocc
IF (h1>h2) CYCLE
v2e(((((m(h5)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))= + v2(((((m(h5)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))
END DO
END DO
END DO
END DO
...
IF (h1>h2) CYCLE
DO h5=1,nocc
i0(((((m(p3)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))=i0(((((m(p3)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))+(-1.0d0)*t1(((m(p3)-1)*N+m(h5)))*v2&
&e(((((m(h5)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))+(1.0d0)*t1(((m(p4)-1)*N+m(h5)))*v2e(((((m(h5)-1)*N+m(p3)-1)*N+m(h1)-1)*N+m(h2)))
END DO
END DO
END DO
END DO
...
DO h2=1,nocc
DO p5=nocc+1,N
v2e(((((m(p3)-1)*N+m(p4)-1)*N+m(h2)-1)*N+m(p5)))= + v2(((((m(p3)-1)*N+m(p4)-1)*N+m(h2)-1)*N+m(p5)))
END DO
END DO
END DO
END DO
...
IF (h1>h2) CYCLE
DO p5=nocc+1,N
i0(((((m(p3)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))=i0(((((m(p3)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(h2)))+(-1.0d0)*t1(((m(p5)-1)*N+m(h1)))*v2&
&e(((((m(p3)-1)*N+m(p4)-1)*N+m(h2)-1)*N+m(p5)))+(1.0d0)*t1(((m(p5)-1)*N+m(h2)))*v2e(((((m(p3)-1)*N+m(p4)-1)*N+m(h1)-1)*N+m(p5)))
END DO
END DO
END DO
END DO
